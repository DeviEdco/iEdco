...
import { fetchDashboardStats } from "@/lib/redux/features/admin/dashboardSlice";

export default function AdminDashboard() {
  const { toast } = useToast();
  const dispatch = useAppDispatch();
  const { stats, status } = useAppSelector((state) => state.adminDashboard);
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between space-x-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  <span className="text-green-500 font-medium">+4.3%</span> from
                  last month
                </p>
              </div>
              <div className="bg-primary/10 p-3 rounded-full">
                    ...
                    <PieChart>
                      <Pie
                        data={[
                          {
                            name: "New Customers",
                            value: stats?.totalCustomers * 0.7 || 0,
                          },
                          {
                            name: "Returning Customers",
                            value: stats?.totalCustomers * 0.3 || 0,
                          },
                        ]}
                        cx="50%"
                        cy="50%"
                    ...
                    <PieChart>
                      <Pie
                        data={[
                          {
                            name: "Credit Card",
                            value: stats?.totalOrders * 0.6 || 0,
                          },
                          { name: "UPI", value: stats?.totalOrders * 0.3 || 0 },
                          {
                            name: "Net Banking",
                            value: stats?.totalOrders * 0.1 || 0,
                          },
                        ]}
                        cx="50%"
                        cy="50%"
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Card className="col-span-3">
              <CardHeader>
                ...
                <CardDescription>
                  Comprehensive sales analysis across all channels
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-96">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Average ratings across product categories
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                    ...
                    <BarChart
                      data={
                        stats?.categoryData?.map((cat) => ({
                          name: cat.name,
                          rating: (Math.random() * 2 + 3).toFixed(1), // Generate random ratings between 3-5
                        })) || []
                      }
                      margin={{
                        top: 5,
